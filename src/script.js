...
const yaomaoMapList = [
    ...
    { name: "山雪游龙", image: "images/山雪游龙.jpg" },
    { name: "火星基地", image: "images/火星基地.jpg" },
    { name: "极星幻域", image: "极星幻域.jpg" },
    { name: "古城秘境", image: "images/古城秘境.jpg" },
    { name: "海滨发卡", image: "images/海滨发卡.jpg" },
    { name: "苏格兰场", image: "images/苏格兰场.jpg" },
    { name: "古堡森林", image: "images/古堡森林.jpg" },
    { name: "超炫基地", image: "images/超炫基地.jpg" },
    { name: "秋之物语", image: "images/秋之物语.jpg" },
    { name: "梦回古蜀", image: "images/梦回古蜀.jpg" },
...
const sidebarPlayersList = document.getElementById('playersList');
...
function init() {
    ...
    // 初始时隐藏记分板
    scoreboardSidebar.classList.remove('active');
}
...
function setupEventListeners() {
    ...
    // 记分板加减分
    sidebarPlayersList.addEventListener('click', (e) => {
...
function switchMapLibrary(mapSet, mapList) {
    ...
    // 显示记分板
    scoreboardSidebar.classList.add('active');
}
...
function renderScoreboard() {
    ...
    players.forEach((player, index) => {
        ...
        `;
        sidebarPlayersList.appendChild(playerItem);
    });
}
